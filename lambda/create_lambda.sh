...
aws iam detach-role-policy --policy-arn arn:aws:iam::aws:policy/AWSComprehendFullAccess --role-name ibd-lambda-role
aws iam detach-role-policy --policy-arn arn:aws:iam::aws:policy/AWSCloudWatchFullAccess --role-name ibd-lambda-role
...
aws iam attach-role-policy --policy-arn arn:aws:iam::aws:policy/AWSComprehendFullAccess --role-name ibd-lambda-role
aws iam attach-role-policy --policy-arn arn:aws:iam::aws:policy/AWSCloudWatchFullAccess --role-name ibd-lambda-role
